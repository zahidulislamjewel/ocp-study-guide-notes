# Chapter 12: Java Platform Module System (JPMS)
...
- Which packages are **visible** outside the module, use `exports`
- Which other modules it **depends on**, use `requires`
- Whether **reflection** is allowed on its packages, use `opens`
- Whether it **consumes** or **provides** services, use `uses` / `provides`
